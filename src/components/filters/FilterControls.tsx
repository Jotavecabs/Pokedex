...
function PillButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        'flex h-[42px] min-w-0 flex-1 items-center justify-center gap-1.5 rounded-full bg-gray-800 px-2 text-sm font-semibold text-white transition-colors hover:bg-black',
